...
import { TaskCard } from "../matura/matematyka-rozszerzona/_components";
import {
...
import { maturaStyleTasks } from "./maturaTasks";
  ...
  return (
    <div className="min-h-screen bg-[#fffeeb] text-stone-800">
      ...
      <main className="max-w-4xl mx-auto px-5 py-16">
        ...
        <div className="mb-12">
          <RuleBox title="Słowniczek pojęć" color="emerald">
        ...
        {/* ─────────────────────────────────────────── */}
        {/* Schemat 1: wykres */}
        <SectionHead spacing="roomy" id="wykres" eyebrow="Schemat 1" title="Jak narysować wykres?" />
        ...
        <SectionHead spacing="roomy" id="zero" eyebrow="Schemat 2" title="Jak znaleźć miejsce zerowe?" />
        ...
        <SectionHead spacing="roomy" id="osie" eyebrow="Schemat 3" title="Przecięcia z osiami OX i OY" />
        ...
        <SectionHead spacing="roomy" id="monotonicznosc" eyebrow="Schemat 4" title="Monotoniczność" />
        ...
        <SectionHead spacing="roomy" id="punkt" eyebrow="Schemat 5" title="Czy punkt należy do prostej?" />
        ...
        <SectionHead spacing="roomy" id="wspolliniowosc" eyebrow="Schemat 6" title="Czy trzy punkty są współliniowe?" />
        ...
        <div className="mt-12">
          <SectionHead spacing="roomy" id={MATURA_SECTION_ID} eyebrow="Praktyka" title="Zadania maturalne" />
